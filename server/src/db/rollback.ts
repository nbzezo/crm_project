...
const ROLLBACKS: Record<number, string> = {
  ...
  41: 'migrate-v41-rollback.sql',
  39: 'migrate-v39-rollback.sql',
  38: 'migrate-v38-rollback.sql',
  37: 'migrate-v37-rollback.sql',
  ...
  34: 'migrate-v34-rollback.sql',
  35: 'migrate-v35-rollback.sql',
};
