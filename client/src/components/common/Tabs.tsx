        ...
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`tr-tab -mb-px inline-flex min-h-[44px] shrink-0 items-center gap-1.5 border-b-2 px-3 text-sm font-medium transition fine:min-h-0 sm:py-2 ${focusRing} ${
                selected
