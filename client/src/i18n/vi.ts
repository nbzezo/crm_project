...
export const t = {
  ...
  auth: {
    ...
    email: 'Email',
    emailHint: 'Tài khoản tạo trước đây vẫn đăng nhập được bằng tên đăng nhập cũ',
    password: 'Mật khẩu',
    signIn: 'Đăng nhập',
    signingIn: 'Đang đăng nhập…',
    signOut: 'Đăng xuất',
    signInFailed: 'Sai email hoặc mật khẩu',
    ...
    forgotSubtitle: 'Nhập email của bạn, hệ thống sẽ gửi liên kết đặt lại mật khẩu.',
    forgotSubmit: 'Gửi liên kết',
    forgotSending: 'Đang gửi…',
    /* Cố ý KHÔNG nói "đã gửi tới email này" — câu trả lời phải giống hệt nhau dù
       email có tồn tại hay không, nếu không màn này thành công cụ dò tài khoản. */
    forgotDone:
      'Nếu địa chỉ này có tài khoản, liên kết đặt lại mật khẩu đã được gửi tới hộp thư. Liên kết có hiệu lực trong 60 phút.',
    backToSignIn: 'Quay lại đăng nhập',

    resetTitle: 'Đặt mật khẩu mới',
    activateTitle: 'Kích hoạt tài khoản',
    activateSubtitle: 'Đặt mật khẩu để bắt đầu dùng WorkFlow.',
    resetSubmit: 'Lưu mật khẩu',
    resetChecking: 'Đang kiểm tra liên kết…',
  ...
  users: {
    ...
    locked: 'Đã khoá',
    pendingInvite: 'Chờ kích hoạt',
    lastLogin: 'Đăng nhập gần nhất',
    never: 'Chưa bao giờ',
    lock: 'Khoá tài khoản',
    unlock: 'Mở khoá',
    resendInvite: 'Gửi lại thư mời',
    signOutEverywhere: 'Đăng xuất mọi thiết bị',
    inviteSent: 'Đã gửi thư mời',
    inviteLinkManual:
  ...
  emailSettings: {
    title: 'Email (SMTP)',
    description:
      'Dùng để gửi thư mời tài khoản và liên kết đặt lại mật khẩu. Chưa cấu hình thì hai việc đó phải làm tay.',
    enabled: 'Bật gửi email',
    host: 'Máy chủ SMTP',
    port: 'Cổng',
    secure: 'Dùng TLS ngay từ đầu (cổng 465)',
    secureHint: 'Tắt nếu dùng STARTTLS — thường là cổng 587.',
    username: 'Tên đăng nhập',
    password: 'Mật khẩu',
    passwordSaved: 'Đã lưu mật khẩu — để trống nếu không muốn đổi',
    clearPassword: 'Xoá mật khẩu đã lưu',
    fromName: 'Tên người gửi',
    fromEmail: 'Địa chỉ gửi đi',
    appBaseUrl: 'Địa chỉ ứng dụng',
    appBaseUrlHint:
      'Gốc URL đặt trong liên kết của thư, ví dụ https://crm.congty.vn. Để trống thì suy từ địa chỉ trình duyệt đang mở — sai khi chạy sau proxy.',
    test: 'Kiểm tra kết nối',
    testing: 'Đang kiểm tra…',
    testOk: 'Kết nối tới máy chủ SMTP thành công',
    sendTest: 'Gửi thư thử',
    sendTestTo: 'Gửi tới địa chỉ',
    sendTestOk: 'Đã gửi thư thử',
